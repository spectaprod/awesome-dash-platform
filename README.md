...
- 2021-03-12: [Dash Podcast 167 with Dash Core Developer Pasta](https://www.youtube.com/watch?v=CwN_RDxcpOc&ab_channel=DigitalCashNetwork) - Dash Core Developer and wunderkind at large Pasta comes on the podcast to give an update on what the Core team has been working on with development. We also go into a deep dive on PrivateSend, Dash's CoinJoin implementation, and the future of possibly renaming it, as well as all the improvements over the years and how it stacks up with other similar coin mixing implementations. We also cover NFTs on Dash, decentralized funding of different projects such as what DashBoost did in the past, and much more.
- 2021-02-12: [Dash Podcast 165 Anton Suprunchuk on Dash Platform Deep Dive](https://www.youtube.com/watch?v=rqsWTYbo2Vo&ab_channel=DigitalCashNetwork) - Dash developer Anton Suprunchuk comes on the Dash Podcast to go into a comprehensive deep dive on Dash Platform, its capabilities, its limitations, and why it matters. We cover a wide variety of pressing questions from the difference between Platform and Ethereum, why it makes sense to do some things on-chain and others off-chain, scaling capabilities of the Platform sidechain, likelihood of stability issues persisting in mainnet, what kinds of things can be built on Dash, and, most importantly, why developers should be very excited to develop on Dash. Probably the most comprehensive place to get a firm understanding on Dash Platform/Evolution out there.
...
- 2021-01-14: [New Dash Investment Could Revolutionize the Whole Cryptocurrency Ecosystem](https://www.youtube.com/watch?v=DyTZhMTEFpI&ab_channel=DigitalCashNetwork) - The Dash Investment Foundation just made an investment in retail savings app CrayPay. This is different from what Litecoin or Tron have done in that the Dash network itself actually owns this property, a revolutionary first in the cryptocurrency and blockchain world. Additionally, this may emulate what "Bitcoin Jesus" Roger Ver was able to achieve in Bitcoin's early days, except give that equity to a network itself and not to an individual or company.
- 2021-01-01: [Dash Podcast 162 Dash Developer Alex Werner on Platform "Evolution" Testnet Release!](https://www.youtube.com/watch?v=ajx88zPKYNs&ab_channel=DigitalCashNetwork) - Dash developer Alex Werner comes on the podcast to talk about Dash Platform testnet release and what it means. We discuss what actually happens with Platform, how it works, why it's useful, and what kinds of things can be built on it, including an in-depth discussion on identity in the future. We also briefly touch on the Bittrex delisting and why that may have happened.
